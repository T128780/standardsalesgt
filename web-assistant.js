(function () {
  ...
  function initAssistant(){
    ...
    root.innerHTML=`<section class="standard-assistant__panel" id="standard-assistant-panel" role="dialog" aria-modal="false" aria-labelledby="standard-assistant-title" hidden>
      ...
      <button class="standard-assistant__launcher" type="button" aria-expanded="false" aria-controls="standard-assistant-panel"><span class="standard-assistant__launcher-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4z" fill="none" stroke="currentColor" stroke-width="2"/></svg></span><span><strong>¿Necesitás ayuda?</strong><small>Consultá al Asistente Standard</small></span></button>`;
